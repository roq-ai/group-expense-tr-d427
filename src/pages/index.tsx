...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Group Expense Tracker Application`}</title>

        <meta
          name="description"
          content="Welcome to Group Expense Tracker Application - Your ultimate solution to track, split, and share group expenses with ease and precision. Experience financial clarity like never before."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1502444330042-d1a1ddf9bb5b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxncm91cCUyQmV4cGVuc2V8ZW58MHx8fHwxNjk4NDA1NTI2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@papaioannou_kostas?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Papaioannou Kostas`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Group Expense Tracker Application - Your ultimate solution to track, split, and share group expenses with ease and precision. Experience financial clarity like never before.`}
            </Text>
            <Box
