...
import { useOrganizationFindFirst, useRoqClient } from 'lib/roq';
...
function OrganizationViewPage() {
  ...
  const { data, error, isLoading } = useOrganizationFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('organization', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/organizations/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="organization" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
